...
function addExperience(arr = null, idx = null) {
    ...
    var htmldata = `
        ...
        <fieldset>
            ...
            <input type='text' id='experience[jobTitle][]' name='experience[jobTitle][]' value='${arr && arr['jobTitle'][idx] ? arr['jobTitle'][idx] : ''}'>
        </fieldset>
        <fieldset>
            <label for='experience[company][]'>Company</label>
            <span class='info'>Required</span>
            <input type='text' id='experience[company][]' name='experience[company][]' value='${arr && arr['company'][idx] ? arr['company'][idx] : ''}'>
        </fieldset>
        <div class='clearfix'></div>
        <fieldset>
            <label for='experience[location][]'>Location</label>
            <span class='info'>Required</span>
            <input type='text' id='experience[location][]' name='experience[location][]' value='${arr && arr['location'][idx] ? arr['location'][idx] : ''}'>
        </fieldset> 
        <div class='clearfix'></div>
        <fieldset>
        ...
        <fieldset class='full-width'>
            ...
            <span class='info'>Required</span>
            <textarea class='no-margin' placeholder='${arr && arr['html-content'][idx] ? arr['html-content'][idx] : 'Describe your job responsibilities, accomplishments and technologies you have used'}' id='experience[html-content][]' name='experience[html-content][]' ></textarea>
        </fieldset>
        <div class='clearfix'></div>
    `;
...
function addEducation(arr = null, idx = null) {
    ...
    var htmldata = `
        ...
        <fieldset>
            ...
            <span class='info'>Required</span>
            <input type='text' id='education[degree][]' name='education[degree][]' value='${arr && arr['degree'][idx] ? arr['degree'][idx] : ''}'>
        </fieldset>
        <fieldset>
            <label for='education[where][]'>School</label>
            <span class='info'>Required</span>
            <input type='text' id='education[where][]' name='education[where][]' value='${arr && arr['where'][idx] ? arr['where'][idx] : ''}'>
        </fieldset>
        <fieldset>
            <label for='education[location][]'>Location</label> 
            <span class='info'>Required</span>
            <input type='text' id='education[location][]' name='education[location][]' value='${arr && arr['location'][idx] ? arr['location'][idx] : ''}'>
        </fieldset>     
        <fieldset>
        ...
        <fieldset class='full-width'>
            ...
            <span class='info'>Required</span>
            <textarea class='no-margin' placeholder='${arr && arr['html-content'][idx] ? arr['html-content'][idx] : 'GPA, Awards, Honors'}' id='education[html-content][]' name='education[html-content][]' ></textarea>
        </fieldset>
        <div class='clearfix'></div>
    `;
